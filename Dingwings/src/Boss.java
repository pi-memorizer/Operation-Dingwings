...
public class Boss extends Enemy 
{
	...
	protected void move()
	{
		...
		if (val < 500)
		{
			...
			{
				super.enemyMove(1, 0);
				if (super.xCoord < 20 && Main.currentRoom.map[super.xCoord + 1][super.yCoord]==Main.BLOCK_WALL)
				{
					right = false;
				}
			}
		...
		else
		{
			...
			{
				super.enemyMove(0, 1);
				if (super.yCoord < 20 && Main.currentRoom.map[super.xCoord][super.yCoord + 1]==Main.BLOCK_WALL)
				{
					up = false;
				}
			}
